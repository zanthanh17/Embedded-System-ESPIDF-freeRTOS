...
#define ESP_RMAKER_PARAM_PH "esp.param.ph"
#define ESP_RMAKER_PARAM_NTU "esp.param.turdibity"
...
#define ESP_RMAKER_DEVICE_PH_SENSOR "esp.device.ph-sensor"
#define ESP_RMAKER_DEVICE_NTU_SENSOR "esp.device.turdibity-sensor"
